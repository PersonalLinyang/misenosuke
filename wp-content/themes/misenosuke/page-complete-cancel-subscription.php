...
if(is_user_logged_in()) :
  if(current_user_can('manager')):
    if(array_key_exists('HTTP_REFERER', $_SERVER) && strpos($_SERVER['HTTP_REFERER'], LANG_DOMAIN . '/cancel-subscription/') !== false):
      $page_title = ucwords($lang->translate('subscription cancellation complete'));
...
<section class="member-section">
  <p class="center"><?php echo ucfirst($lang->translate('subscription is cancelled successfully')); ?></p>
  <p class="center">
    <?php echo ucfirst($lang->translate('please confirm your subscription and refund on member page')); ?>
  </p>
  <p class="center">
